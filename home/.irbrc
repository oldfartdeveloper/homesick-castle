...
require "~/work/hedgeye-cms/tools/sf_re_user_diff/lib/sync_tool.rb"
...
is_rails = ENV.include?('RAILS_ENV')
if is_rails && !Object.const_defined?('RAILS_DEFAULT_LOGGER')
  require 'logger'
  RAILS_DEFAULT_LOGGER = Logger.new(STDOUT)
end

# define lst to bring in Forrest's utilities
def lst
  require '~/work/hedgeye-cms/tools/sf_re_user_diff/lib/sync_tool'
end
